(function () {
    ...
    var mvpizer = angular.module('mvpizer', ['duScroll']);

    mvpizer
        .controller('AppCtrl', function ($scope, cssInjector, $document) {
            ...
            cssInjector.add("css/creative.red.css");


            $scope.change = function () {
                cssInjector.removeAll();
                cssInjector.add("css/creative.blue.css");
            }
